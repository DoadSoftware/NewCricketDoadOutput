...
public class Animation 
{
	...
	public String getTypeOfGraphicsOnScreen(Configuration config,String whatToProcess)
	{
		...
		case Constants.BENGAL_T20: case Constants.AFG_T20:
			switch (whatToProcess.split(",")[0]) {
			case "F1": case "Control_Shift_A": case "F2": case "F4": case "Shift_F10": case "Control_F11": case "Shift_F11": case "m": case "Control_m": 
			case "Shift_T": case "Control_d": case "Control_e": case "Control_F7": case "Control_F10": case "9": case "Shift_K": case "Alt_F9": case "Shift_D": 
			case "p": case "Control_b": case "Alt_m": case "Alt_n": case "Alt_F10": case "Control_F1": case "Control_p": case "Shift_P": case "Shift_Q": 
			case "z": case "x": case "c": case "v": case "Alt_F11": case "Alt_z": case "Control_z": case "Control_x": case "r": case "Shift_Z": case "Shift_X": 
			case "Control_Shift_F1": case "Control_Shift_D": case "Alt_Shift_Z": case "Control_Shift_F7": case "Control_Shift_F2": case "Alt_Shift_R": 
			case "Control_Shift_F4": case "Control_Shift_Z": case "Control_Shift_Y": case "Control_Shift_F8": case "Alt_Shift_U":
				return Constants.FULL_FRAMER;
		...
		case Constants.ISPL:
			...
			case "Control_s": case "Alt_d": case "Alt_l": case "Control_f": case "Control_q": case "l": case "Control_Shift_F9": case "a": case "Control_F2":
...
//				}
	...
	public String Legend_AnimateIn(String whatToProcess, List<PrintWriter> print_writers, Configuration config) throws InterruptedException, IOException
	{
		switch (config.getBroadcaster().toUpperCase()) {
		case Constants.LEGENDS: case Constants.ASSAM:
			switch (whatToProcess.split(",")[0]) {
...
//					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*FRONT_LAYER*TREE*$Extra_PopUp$TextGrp$Select*FUNCTION*Omo*vis_con SET 1\0", print_writers);
					...
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*FRONT_LAYER*TREE*$Extra_PopUp_New$Select*FUNCTION*Omo*vis_con SET 7\0", print_writers);
				}
...
//					processAnimation(Constants.FRONT, print_writers, "Extra_PopUps", "START");
			...
			case "w": case "i": case "f": case "s": case "0": case "8": case "Control_F8":
				if(whatToProcess.split(",")[0].equalsIgnoreCase("w")) {
					...
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*FRONT_LAYER*TREE*$Extra_PopUp_New$Select*FUNCTION*Omo*vis_con SET 1\0", print_writers);
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*FRONT_LAYER*TREE*$Infobar$Wipes$Select*FUNCTION*Omo*vis_con SET 3 \0", print_writers);
					...
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*FRONT_LAYER*TREE*$Extra_PopUp_New$Select*FUNCTION*Omo*vis_con SET 2\0", print_writers);
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*FRONT_LAYER*TREE*$Infobar$Wipes$Select*FUNCTION*Omo*vis_con SET 4 \0", print_writers);
			...
			case "Control_Shift_Q":	case "Alt_l":
				if(!infobar.getInfobar_status().equalsIgnoreCase(Constants.FORCED+Constants.SHRUNK_INFOBAR)) {
					AnimateIn("ArrowLeft" + ",", print_writers, config); // Shrink infobar
					TimeUnit.MILLISECONDS.sleep(1000);
					infobar.setInfobar_status(Constants.SHRUNK_INFOBAR);
	...
	public String AnimateIn(String whatToProcess, List<PrintWriter> print_writers, Configuration config) throws InterruptedException, IOException 
	{
		...
		case Constants.ISPL:
			...
			break;
		case Constants.LEGENDS: case Constants.ASSAM:
			Legend_AnimateIn(whatToProcess, print_writers, config);
			break;
...
//					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*FRONT_LAYER*TREE*$Extra_PopUp$TextGrp$Select*FUNCTION*Omo*vis_con SET 1\0", print_writers);
				...
				if(this.infobar.isInfobar_on_screen() == true && !this.infobar.isInfobar_pushed()) {
					processAnimation(Constants.FRONT, print_writers, "Extra_PopUp_New", "START");
//					processAnimation(Constants.FRONT, print_writers, "Extra_PopUpfs", "START");
				}
				break;
			...
			case "Control_Shift_K":
				...
				processAnimation(Constants.BACK, print_writers, "Anim_FullFrames$In_Out$SubHeader", "START");
				processAnimation(Constants.BACK, print_writers, "Anim_FullFrames$In_Out$ExtraData", "START");
				processAnimation(Constants.BACK, print_writers, "Anim_FullFrames$In_Out$Main$Playoff_Tree", "START");
...
//				processAnimation(Constants.BACK, print_writers, "Anim_FullFrames$In_Out$Logo", "START");
			...
			case "Control_Alt_F1": case "Control_Alt_F2": case "Alt_F5":
				...
				case Constants.NPL: case Constants.MPL: case Constants.APL:
					...
					if(!whatToProcess.split(",")[0].equalsIgnoreCase("Alt_F11") && !whatToProcess.split(",")[0].equalsIgnoreCase("Control_Shift_E") && 
...
//						processAnimation(Constants.BACK, print_writers, "Anim_FullFrames$In_Out$Sponsor", "START");
			...
			case "Alt_Shift_F3":
				...
				processAnimation(Constants.FRONT, print_writers, "LT_Phase_Comp$In_Out", "START");
				this.whichGraphicOnScreen = whatToProcess;
				break;
...
//				processAnimation(Constants.FRONT, print_writers, "Sponsor", "START");
		...
		case Constants.ICC_U19_2023:
			...
			case "Alt_Shift_E":case "Alt_Shift_F":case "Alt_Shift_G":case "Alt_Shift_H": case "Control_u": case "Shift_G": case "Shift_W":case "Control_Shift_X":	case "Alt_l":
				if(this.infobar.isInfobar_on_screen() == true) {
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*FRONT_LAYER*TREE*$All_LowerThirds$Overall_Position_Y*"
						+ "TRANSFORMATION*POSITION*Y SET 40.0 \0",print_writers);
				}else {
...
//				break;
			...
			case "Alt_z": case "Alt_Shift_U":
				...
				if(!whatToProcess.split(",")[0].equalsIgnoreCase("Shift_K") && !whatToProcess.split(",")[0].equalsIgnoreCase("z") &&
						...
						!whatToProcess.split(",")[0].equalsIgnoreCase("Alt_Shift_U")) {
					processAnimation(Constants.BACK, print_writers, "Anim_FullFrames$In_Out$Footer", "START");
				}
				...
				case "Control_p":
					...
					break;
				case "z": case "x": case "c": case "v": case "Control_z": case "Control_x": case "Control_Shift_Z": case "Control_Shift_Y":
				case "Control_Shift_F8": case "Shift_Z": case "Shift_X": case "Alt_Shift_U":
			...
			case "w": case "i": case "f": case "s": case "0": case "8":
				if(whatToProcess.split(",")[0].equalsIgnoreCase("w")) {
				...
				}else if(whatToProcess.split(",")[0].equalsIgnoreCase("0") || whatToProcess.split(",")[0].equalsIgnoreCase("8")) {
					switch(whatToProcess.split(",")[0]) {
					case "0":
						CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*FRONT_LAYER*TREE*$gfx_Infobar$Main$Fade_For_Shrink$Animation$Hat_Trick_Ball$txt_Title1"
								+ "*GEOM*TEXT SET ON A HAT-TRICK\0", print_writers);
						CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*FRONT_LAYER*TREE*$gfx_Infobar$Main$Fade_For_Shrink$Animation$Hat_Trick_Ball$txt_Title2"
								+ "*GEOM*TEXT SET ON A HAT-TRICK\0", print_writers);
						break;
					case "8":
						CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*FRONT_LAYER*TREE*$gfx_Infobar$Main$Fade_For_Shrink$Animation$Hat_Trick_Ball$txt_Title1"
								+ "*GEOM*TEXT SET HAT-TRICK\0", print_writers);
						CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*FRONT_LAYER*TREE*$gfx_Infobar$Main$Fade_For_Shrink$Animation$Hat_Trick_Ball$txt_Title2"
								+ "*GEOM*TEXT SET HAT-TRICK\0", print_writers);
						break;
					}
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*FRONT_LAYER*TREE*$gfx_Infobar$Main$Fade_For_Shrink$Animation$Select_Type*FUNCTION*Omo*vis_con SET 5 \0", print_writers);
				}
	...
	private void T20_VidarbhaAnimateIn(String whatToProcess, List<PrintWriter> print_writers, Configuration config) throws InterruptedException, IOException {
		...
		case "Control_Shift_D":
			AnimateIn("ArrowDown,", print_writers, config); // Push infobar
			TimeUnit.MILLISECONDS.sleep(500);
			processAnimation(Constants.BACK, print_writers, "AnimMatchId_Double$In_Out", "START");
			this.whichGraphicOnScreen = whatToProcess;
			break;
		case "m": case "Control_m":
			AnimateIn("ArrowDown,", print_writers, config); // Push infobar
		...
		case "Control_c": case "Control_v": case "Shift_V": case "Control_z": case "Control_x": case "Shift_F10": case "Control_d": case "Control_e":
			...
			processAnimation(Constants.BACK, print_writers, "Anim_FullFrames$In_Out$Legend", "START");
			processAnimation(Constants.BACK, print_writers, "Anim_FullFrames$In_Out$Header_ILU", "START");
		...
		case "Shift_R": case "Shift_U": case "Alt_w": case "Control_j": case "Alt_i": case "Alt_j": case "b": case "Control_i": case "Alt_Shift_D":
		case "Alt_Shift_E":case "Alt_Shift_F":case "Alt_Shift_G":case "Alt_Shift_H": case "Control_u": case "Shift_G": case "Shift_W":
...
//							+ "ANIMATION*KEY*$Shrink_In*VALUE SET 120.0 -436.0 0.0\0",print_writers);
	...
	public String AnimateOut(String whatToProcess, List<PrintWriter> print_writers, Configuration config) throws InterruptedException, IOException
	{
		...
		case Constants.LEGENDS: case Constants.ASSAM:
			...
			case "F10": case "a":case "Alt_Shift_F5":case "Alt_Shift_F7":case "Alt_Shift_F6": case "Alt_d": case "Alt_Shift_F3": case "Alt_l":
...
//				}
				...
				processAnimation(Constants.BACK, print_writers, "Anim_FullFrames$In_Out$SubHeader", "CONTINUE");
				processAnimation(Constants.BACK, print_writers, "Anim_FullFrames$In_Out$ExtraData", "CONTINUE");
				processAnimation(Constants.BACK, print_writers, "Anim_FullFrames$In_Out$Main$Playoff_Tree", "CONTINUE");
				processAnimation(Constants.BACK, print_writers, "BG_Scale", "CONTINUE REVERSE");
...
//					processAnimation(Constants.FRONT, print_writers, "Audio$Out", "START");
//				}
				processAnimation(Constants.FRONT, print_writers, "LT_Phase_Comp$In_Out", "CONTINUE");
				if(!infobar.getInfobar_status().equalsIgnoreCase(Constants.FORCED+Constants.SHRUNK_INFOBAR)) {
					TimeUnit.MILLISECONDS.sleep(1000);
					AnimateIn("ArrowRight" + ",", print_writers, config); // Restore infobar
					infobar.setInfobar_status(Constants.TWO_LINER_INFOBAR);
				...
				TimeUnit.MILLISECONDS.sleep(500);
				processAnimation(Constants.FRONT, print_writers, "LT_Phase_Comp$In_Out", "SHOW 0.0");
				this.whichGraphicOnScreen = "";
				break;
...
//					break;
			...
			case "Shift_B": case "Control_Shift_F": case "Control_Shift_P": case "Alt_l":
			case "Alt_Shift_D":case "Alt_Shift_E":case "Alt_Shift_F":case "Alt_Shift_G":case "Alt_Shift_H":
			case "Control_u": case "Shift_G": case "Shift_W":case "Control_Shift_X":
				processAnimation(Constants.FRONT, print_writers, "anim_Lower_Third", "CONTINUE");
				processAnimation(Constants.FRONT, print_writers, "Anim_LtChange$Lt_X_Position", "CONTINUE REVERSE");
...
//				break;
			...
			case "Shift_Z": case "Shift_X": case "Control_Shift_F1": case "Control_Shift_F2": case "Control_Shift_F4": case "Alt_z": case "Alt_Shift_U":
			...
			case "Alt_Shift_H": case "Control_u": case "Shift_G": case "Shift_W":case "Control_Shift_X": case "Alt_l":
				processAnimation(Constants.FRONT, print_writers, "anim_Lower_Third", "CONTINUE");
				TimeUnit.MILLISECONDS.sleep(1000);
				AnimateIn(Constants.SHRUNK_INFOBAR + ",", print_writers, config); // Restore infobar
				this.whichGraphicOnScreen = "";
...
//					}
		...
		case Constants.LEGENDS: case Constants.ASSAM:
			...
			case "Control_F3": case "Alt_k": case "Shift_F3": case "u": case "d": case "e": case "Shift_F5": case "Shift_F9": case "Alt_F12":
			case "Control_h":  case "Control_F6": case "Shift_F6": case "Control_s": case "Control_f":  case "Shift_E": case "Alt_F8": case "F8": 
			case "F10": case "a": case "Alt_Shift_F5": case "Alt_Shift_F7": case "Alt_Shift_F6": case "Alt_d": case "Alt_Shift_F3": case "Control_Shift_Q":
			case "Alt_l":	
				processAnimation(Constants.FRONT, print_writers, "anim_LT_Change", "START");
				processAnimation(Constants.FRONT, print_writers, "Lt_Position", "START");
				break;
...
//						}
				...
				case "Alt_8":
					if(whatToProcess.split(",")[2].equalsIgnoreCase(CricketUtil.BOWLER) && infobar.isTarget_on_screen() == true) {
						...
						processAnimation(Constants.FRONT, print_writers, "Anim_Infobar$Impact_Bowl", "SHOW 0.0");
						processAnimation(Constants.FRONT, print_writers, "Anim_Infobar$Right_Bowl_Full_Over$In_Out", "START");
						TimeUnit.MILLISECONDS.sleep(700);
						infobar.setRight_section(whatToProcess.split(",")[2]);
						infobar.setTarget_on_screen(true);
						infobar.setRight_bottom_play(false);
						processAnimation(Constants.FRONT, print_writers, "Anim_Infobar$Bowl_All", "SHOW 0.0");
					}else if(!infobar.getRight_section().equalsIgnoreCase(CricketUtil.BOWLER) && infobar.isTarget_on_screen() == true) {
						processAnimation(Constants.FRONT, print_writers, "Anim_Infobar$Impact_Bowl", "SHOW 0.0");
						processAnimation(Constants.FRONT, print_writers, "Anim_Infobar$Right_Bowl_Full_Over$In_Out", "CONTINUE");
						processAnimation(Constants.FRONT, print_writers, "Anim_Infobar$Bowl_All$In_Out", "CONTINUE");
						infobar.setRight_section(whatToProcess.split(",")[2]);
			...
			case "Shift_F8": case "Control_Shift_F1": case "Control_Shift_F2": case "Control_Shift_F4":
				...
				if(whichGraphicOnScreen.contains(",")) {
					...
					case "F2": 
						...
						switch(whatToProcess.split(",")[0]) {
						case "F2": case "F1": case "Control_Shift_A": case "Control_Shift_F1": case "Control_Shift_F2": case "F4":
							break;
						default:
							processAnimation(Constants.BACK, print_writers, "Anim_FullFrames$In_Out$Sponsor", "CONTINUE REVERSE");
							break;
					...
					case "Control_Shift_F1":
						...
						switch(whatToProcess.split(",")[0]) {
						case "F2": case "F1": case "Control_Shift_A": case "Control_Shift_F2": case "F4":
							break;
						case "Control_Shift_F1":
							if(caption.this_fullFramesGfx.WhichType.equalsIgnoreCase("performer")) {
								processAnimation(Constants.BACK, print_writers, "Anim_Highlights$Batting_Card$Side1$" + 
					...
					case "Control_Shift_F2":
						...
						switch(whatToProcess.split(",")[0]) {
						case "F2": case "F1": case "Control_Shift_A": case "Control_Shift_F1": case "F4":
							break;
						case "Control_Shift_F2":
							processAnimation(Constants.BACK, print_writers, "Anim_Highlights$Bowling_Card$Side1$" + 
									caption.this_fullFramesGfx.pervious_ballperformer_id, "CONTINUE REVERSE");
...
//			setVariousAnimationsKeys("CHANGE-ON", print_writers, config);
			...
			processAnimation(Constants.BACK, print_writers, "Change$Legend", "START");
			processAnimation(Constants.BACK, print_writers, "Change$Header_ILU", "START");
...
//			}
		...
		case "Alt_1": case "Alt_2": case "Alt_3": case "Alt_4": case "Alt_5": case "Alt_6": case "Alt_7": case "Alt_8": case "Alt_9": case "Alt_0":
			...
			case "Alt_3": case "Alt_4":
				...
				default:
					if(infobar.getFull_section() != null && !infobar.getFull_section().trim().isEmpty()) {
						...
						processAnimation(Constants.FRONT, print_writers, "Anim_InfoBar$Sateg2$Stage2_Out", "START");
			...
			case "Alt_1": case "Alt_9": case "Alt_0":
				...
				break;
			case "Alt_2": case "Alt_5": case "Alt_6":
				switch (config.getBroadcaster().toUpperCase()) {
				case Constants.VIDARBHA: 
					if(whatToProcess.split(",")[2].equalsIgnoreCase(CricketUtil.BATSMAN)) {
...
//				 setVariousAnimationsKeys("CUT-BACK", print_writers, config);
			 ...
			 case "Shift_F8": case "Control_F11": case "Shift_K":
				 TimeUnit.MILLISECONDS.sleep(500);
					...
					processAnimation(Constants.BACK, print_writers, "Change$Legend", "SHOW 0.0");
					processAnimation(Constants.BACK, print_writers, "Change$Header_ILU", "SHOW 0.0");
...
//				break;
		...
		case Constants.LEGENDS: case Constants.ASSAM:
			...
			case "Alt_Shift_F7": case "Alt_Shift_F6": case "Alt_d": case "Alt_Shift_F3": case "Control_Shift_Q": case "Alt_l":
...
//			}
		...
		case "Shift_F1":  case "Shift_F2": case "Alt_F1": case "Alt_F2":
			...
			break;
		case "Alt_F7":
			processAnimation(Constants.FRONT, print_writers, "anim_MiniStandings$In_Out", "START");
			this.whichGraphicOnScreen = whatToProcess;
			break;
...
//			}
		...
		case "Alt_Shift_O": case "d": case "e": case "Control_f": case "Control_i": case "Alt_Shift_B":
			if(this.infobar.isInfobar_on_screen() == true) {
		...
		case "Alt_Shift_K": case "Alt_Shift_X": case "Alt_Shift_T": case "Alt_Shift_V":
			processAnimation(Constants.BACK, print_writers, "anim_LOF_LeaderBoard$In_Out$In", "START");
			this.whichGraphicOnScreen = whatToProcess;
			TimeUnit.MILLISECONDS.sleep(2700);
			processAnimation(Constants.BACK, print_writers, "anim_LOF_LeaderBoard$In_Out", "SHOW 2.500");
			break;
		...
		case "F1": case "Control_Shift_F1": case "F2": case "Control_F11": case "Shift_F11": case "F4": case "Shift_K": case "Control_F7": case "Shift_F10": case "p": 
		...
		case "Alt_Shift_F9": case "Control_Shift_F12": case "Alt_Shift_F1": case "Alt_Shift_F2": case "z": case "x": case "c": case "v": case "Control_z": case "Control_x":
		case "Control_Shift_Z": case "Control_Shift_Y":
			...
			case "Alt_Shift_F1": case "Alt_Shift_F2":
				processAnimation(Constants.BACK, print_writers, "MoveForImageCard", "START");
				processAnimation(Constants.BACK, print_writers, "anim_FullFrames$In_Out$Main$ImageCard", "START");
				break;
			case "z": case "x": case "c": case "v": case "Control_z": case "Control_x": case "Control_Shift_Z": 
			case "Control_Shift_Y":
				//processAnimation(Constants.BACK, print_writers, "anim_FullFrames$In_Out$Main$Leaderboard", "START");
				processAnimation(Constants.BACK, print_writers, "MoveForImageCard", "START");
				processAnimation(Constants.BACK, print_writers, "anim_FullFrames$In_Out$Main$LeaderBoardImage", "START");
				break;
			case "F4":
	...
	public String VidharbaAnimateOut(String whatToProcess, List<PrintWriter> print_writers,Configuration config) throws InterruptedException, IOException {
		switch (whatToProcess.split(",")[0]) {
		case "9":
			processAnimation(Constants.MIDDLE, print_writers, "Plotter", "CONTINUE");
			this.whichGraphicOnScreen = "";
		...
		case "Alt_Shift_Q":
			...
			break;
		case "Control_Shift_D":
			processAnimation(Constants.BACK, print_writers, "AnimMatchId_Double$In_Out", "CONTINUE");
			TimeUnit.MILLISECONDS.sleep(1000);
			processAnimation(Constants.BACK, print_writers, "AnimMatchId_Double$In_Out", "SHOW 0.0");
			AnimateIn("ArrowUp,", print_writers, config); // Restore infobar
			this.whichGraphicOnScreen = "";
			break;
		case "m": case "Control_m":
		...
		case "Shift_V": case "Control_F10": case "Control_z": case "Control_x": case "Shift_F10": case "Control_d": case "Control_e":
			...
			processAnimation(Constants.BACK, print_writers, "Anim_FullFrames$In_Out$Legend", "CONTINUE");
			processAnimation(Constants.BACK, print_writers, "Anim_FullFrames$In_Out$Header_ILU", "CONTINUE");
...
//			processAnimation(Constants.FRONT, print_writers, "anim_Lower_Third$Top_Header", "SHOW 2.680");
		...
		case "Alt_Shift_L": case "Alt_d": case "Alt_l": case "l": case "a": case "Alt_F6": case "Shift_A": case "Shift_R": 
		case "Shift_U": case "Alt_w": case "Control_j": case "Alt_i": case "Alt_j": case "b": case "Control_i": case "Alt_Shift_D":
		case "Alt_Shift_E":case "Alt_Shift_F":case "Alt_Shift_G":case "Alt_Shift_H": case "Control_u": case "Shift_G": 
...
//			}
		...
		case "Shift_F1":  case "Shift_F2": case "Alt_F1": case "Alt_F2":
			...
			break;
		case "Alt_F7":
			processAnimation(Constants.FRONT, print_writers, "anim_MiniStandings$In_Out", "CONTINUE");
			this.whichGraphicOnScreen = "";
			TimeUnit.MILLISECONDS.sleep(1000);
		...
		case "Alt_Shift_O":case "d": case "e": case "Alt_Shift_B": case "Control_i": 
			if(audioenabled.equalsIgnoreCase("TRUE")) {
				processAnimation(Constants.FRONT, print_writers, "sfx_Out", "START");
			}
		...
		case "F1": case "Control_Shift_F1": case "F2": case "Control_F11": case "F4": case "Shift_K": case "Control_F7": case "Shift_F10": case "Shift_F11": 
		case "p": case "Alt_Shift_J": case "Control_F1": case "Alt_F9": case "Shift_F8": case "Control_F10": case "Control_Shift_F2": case "Alt_Shift_F10": 
		case "Alt_Shift_F12": case "Alt_Shift_F9": case "Control_Shift_F12": case "Alt_Shift_F1": case "Alt_Shift_F2": case "z": case "x": case "c": case "v": 
		case "Control_z": case "Control_x": case "Control_Shift_Z": case "Control_Shift_Y":
			if(audioenabled.equalsIgnoreCase("TRUE")) {
				processAnimation(Constants.BACK, print_writers, "AUDIO$sfx_FF_Out", "START");
			}
			switch(whatToProcess.split(",")[0]) {
			...
			case "Control_Shift_F12":
				...
				break;
			case "Alt_Shift_F1": case "Alt_Shift_F2":
				processAnimation(Constants.BACK, print_writers, "anim_FullFrames$In_Out$Main$ImageCard", "CONTINUE");
				break;
			case "z": case "x": case "c": case "v": case "Control_z": case "Control_x": case "Control_Shift_Z": case "Control_Shift_Y":
				//processAnimation(Constants.BACK, print_writers, "anim_FullFrames$In_Out$Main$Leaderboard", "CONTINUE");
				processAnimation(Constants.BACK, print_writers, "anim_FullFrames$In_Out$Main$LeaderBoardImage", "CONTINUE");
				break;
			case "F4":
			...
			processAnimation(Constants.BACK, print_writers, "MoveForImageCard", "SHOW 0.0");
	...
	public String T20_MumbaiChangeOn(String whatToProcess, List<PrintWriter> print_writers,Configuration config) throws InterruptedException, IOException {
		...
		case "d": case "e":case "Alt_F1": case "Alt_F2": case "Control_i": case "Alt_Shift_B": 
...
//			}
		...
		case "Control_Shift_Z": case "Control_Shift_Y":
			...
			if(whichGraphicOnScreen.contains(",")) {
				...
				case "Control_Shift_F12":
					...
					break;
				case "Alt_Shift_F1": case "Alt_Shift_F2":
					processAnimation(Constants.BACK, print_writers, "Change_Fullframes$ImageCard", "START");
					if(!whatToProcess.split(",")[0].split(",")[0].equalsIgnoreCase("Alt_Shift_F1") && 
							!whatToProcess.split(",")[0].split(",")[0].equalsIgnoreCase("Alt_Shift_F2")) {
						if(!whichGraphicOnScreen.split(",")[0].equalsIgnoreCase(whatToProcess.split(",")[0])) {
							processAnimation(Constants.BACK, print_writers, "MoveForImageCard", "CONTINUE REVERSE");
						}
					}
					break;
				case "F4":
				...
				case "z": case "x": case "c": case "v": case "Control_z": case "Control_x": case "Control_Shift_Z": 
				case "Control_Shift_Y":
					//processAnimation(Constants.BACK, print_writers, "Change_Fullframes$Leaderboard", "START");
					processAnimation(Constants.BACK, print_writers, "Change_Fullframes$LeaderBoardImage", "START");
					switch (whatToProcess.split(",")[0]) {
					case "z": case "x": case "c": case "v": case "Control_z": case "Control_x": case "Control_Shift_Z": 
					case "Control_Shift_Y":
					        break; // Do nothing
			...
			if(!whichGraphicOnScreen.split(",")[0].equalsIgnoreCase(whatToProcess.split(",")[0])) {
				...
				case "Control_Shift_F12":
					...
					break;
				case "Alt_Shift_F1": case "Alt_Shift_F2":
					if(!whichGraphicOnScreen.split(",")[0].equalsIgnoreCase("Alt_Shift_F1") && 
							!whichGraphicOnScreen.split(",")[0].equalsIgnoreCase("Alt_Shift_F2")) {
						processAnimation(Constants.BACK, print_writers, "MoveForImageCard", "START");
						processAnimation(Constants.BACK, print_writers, "Change_Fullframes$ImageCard", "START");
					}
					break;
	...
	public String T20_MumbaiCutBack(String whatToProcess, List<PrintWriter> print_writers,Configuration config) throws InterruptedException, IOException {
		...
		case "Alt_Shift_F3":case "Alt_Shift_O":case "d": case "e": case "Control_i": case "Alt_Shift_B":
...
//			}
		...
		case "F1": case "Control_Shift_F1": case "F2": case "Control_F11": case "F4": case "Shift_K": case "Control_F7": case "Shift_F11": case "Shift_F10": case "p": 
		case "Control_F1": case "Alt_F9": case "Shift_F8": case "Control_F10": case "Control_Shift_F2": case "Alt_Shift_F10": case "Alt_Shift_F12": case "Alt_Shift_F9": 
		case "Control_Shift_F12": case "Alt_Shift_F1": case "Alt_Shift_F2": case "z": case "x": case "c": case "v": case "Control_z": case "Control_x":
		case "Control_Shift_Z": case "Control_Shift_Y":
			...
			case "Control_Shift_F12":
				...
				break;
			case "Alt_Shift_F1": case "Alt_Shift_F2":
				processAnimation(Constants.BACK, print_writers, "Change_Fullframes$ImageCard", "SHOW 0.0");
				break;
			case "F4":
			...
			case "z": case "x": case "c": case "v": case "Control_z": case "Control_x": case "Control_Shift_Z": 
			case "Control_Shift_Y":
				//processAnimation(Constants.BACK, print_writers, "Change_Fullframes$Leaderboard", "SHOW 0.0");
				processAnimation(Constants.BACK, print_writers, "Change_Fullframes$LeaderBoardImage", "SHOW 0.0");
				break;
			}
			...
			case "Control_Shift_F12":
				...
				break;
			case "Alt_Shift_F1": case "Alt_Shift_F2":
				processAnimation(Constants.BACK, print_writers, "anim_FullFrames$In_Out$Main$ImageCard", "SHOW 2.820");
				processAnimation(Constants.BACK, print_writers, "Change_Fullframes$ImageCard", "SHOW 0.0");
				break;
			case "F4":
			...
			case "Control_F1":
				...
				break;
			case "z": case "x": case "c": case "v": case "Control_z": case "Control_x": case "Control_Shift_Z": case "Control_Shift_Y":
				//processAnimation(Constants.BACK, print_writers, "anim_FullFrames$In_Out$Main$Leaderboard", "SHOW 2.820");
				//processAnimation(Constants.BACK, print_writers, "Change_Fullframes$Leaderboard", "SHOW 0.0");
				processAnimation(Constants.BACK, print_writers, "anim_FullFrames$In_Out$Main$LeaderBoardImage", "SHOW 2.820");
				processAnimation(Constants.BACK, print_writers, "Change_Fullframes$LeaderBoardImage", "SHOW 0.0");
				break;
			}
			this.whichGraphicOnScreen = whatToProcess;
...
//					infobar.setRight_section("");
	...
	public String ResetAnimation(String whatToProcess, List<PrintWriter> print_writers, Configuration config) throws InterruptedException
	{
		...
		case Constants.VIDARBHA: case Constants.ODISHA:
			...
			processAnimation(Constants.BACK, print_writers, "AnimMatchId_Double", "SHOW 0.0");
			processAnimation(Constants.BACK, print_writers, "Anim_Target", "SHOW 0.0");
	...
	public void processT20_MumbaiFullFramesPreview(String whatToProcess, List<PrintWriter> print_writer, int whichside, Configuration config,String whichGraphicOnScreen) {
		...
		if(whichside == 1) {
			...
			case "Shift_T":
				...
				break;
			case "Alt_Shift_K": case "Alt_Shift_X": case "Alt_Shift_T": case "Alt_Shift_V":
				previewCommand = "anim_LOF_LeaderBoard$In_Out$In 2.500";
				break;
			...
			case "Control_F1": case "Alt_F9": case "Shift_F8": case "Control_F10": case "Control_Shift_F2": case "Alt_Shift_F10": case "Alt_Shift_F12": case "Alt_Shift_F9": case "Control_Shift_F12": 
			case "Alt_Shift_F1": case "Alt_Shift_F2": case "z": case "x": case "c": case "v": case "Control_z": case "Control_x": case "Control_Shift_Z": case "Control_Shift_Y":
				...
				case "Control_F1":
					...
					break;
				case "z": case "x": case "c": case "v": case "Control_z": case "Control_x": case "Control_Shift_Z": case "Control_Shift_Y":
					//previewCommand = previewCommand + "anim_FullFrames$In_Out$Main$Leaderboard$In 1.900";
					previewCommand = previewCommand + "anim_FullFrames$In_Out$Main$LeaderBoardImage$In 2.356 MoveForImageCard 0.603";
					break;
				}
				break;
			}
			...
			case "Alt_Shift_F1": case "Alt_Shift_F2": case "z": case "x": case "c": case "v": case "Control_z": case "Control_x": case "Control_Shift_Z": case "Control_Shift_Y":
				...
				case "Control_F1":
					...
					break;
				case "z": case "x": case "c": case "v": case "Control_z": case "Control_x": case "Control_Shift_Z": case "Control_Shift_Y":
					//previewCommand = previewCommand + " Change_Fullframes$Leaderboard 1.000 Change_Fullframes$Leaderboard$Change_Out 0.400 Change_Fullframes$Leaderboard$Change_In 1.000";
					previewCommand = previewCommand + " Change_Fullframes$LeaderBoardImage 1.346 Change_Fullframes$LeaderBoardImage$Change_Out 0.580 Change_Fullframes$LeaderBoardImage$Change_In 1.346";
					switch (whatToProcess.split(",")[0]) {
					case "z": case "x": case "c": case "v": case "Control_z": case "Control_x": case "Control_Shift_Z": case "Control_Shift_Y":
					        break; // Do nothing
				    default:
				...
				if(!whichGraphicOnScreen.split(",")[0].equalsIgnoreCase(whatToProcess.split(",")[0])) {
					...
					case "Alt_Shift_F1":  case "Alt_Shift_F2":
						previewCommand = previewCommand + " Change_Fullframes$ImageCard 1.300 Change_Fullframes$ImageCard$Change_Out 0.640 Change_Fullframes$ImageCard$Change_In 1.300";
						if(!whichGraphicOnScreen.split(",")[0].equalsIgnoreCase("Alt_Shift_F1") && !whichGraphicOnScreen.split(",")[0].equalsIgnoreCase("Alt_Shift_F2")) {
							previewCommand = previewCommand + " MoveForImageCard 0.603";
						}
						break;
					case "F4":
					...
					case "Control_F10":
						...
						break;
					case "p":
						previewCommand = previewCommand + " Change_Fullframes$Standings 1.120 Change_Fullframes$Standings$Change_Out 0.460 Change_Fullframes$Standings$Change_In 1.120";
						break;
					case "Alt_Shift_J":
	                ...
	                if(whatToProcess.contains(",")) {
	                    ...
	                    case "Shift_F10":
	                        previewCommand = "Anim_Infobar$Push 0.500 Anim_FullFrames$In_Out$Essentials$In 2.140 Anim_FullFrames$In_Out$Header$In 2.100 "
	                        		+ "Anim_FullFrames$In_Out$Legend$In_Out$In 1.300 Anim_FullFrames$In_Out$Header_ILU$In 1.800";
	                        break;
	                    case "m": case "Control_m":
	                        previewCommand = "Anim_MatchId$In_Out$In 1.700";
	                        break;
	                    case "Control_Shift_D":
	                        previewCommand = "AnimMatchId_Double$In_Out$In 1.700";
	                        break;
	                    case "Shift_D":
	                    ...
	                    case "Control_F10":
	                        ...
	                        break;
	                    case "Shift_F10":
	                        previewCommand = previewCommand + " Anim_FullFrames$In_Out$Main$Worm$In 2.000 Anim_FullFrames$In_Out$Main$Worm$In$In 2.000";
	                        break;
	                    case "Control_p":
	                ...
	                if(whatToProcess.contains(",")) {
	                    ...
	                    case "Control_p": case "z": case "x": case "c": case "v": case "Control_z": case "Control_x":
	                        previewCommand = previewCommand + "Change$Header 1.600 Change$Header$Change_In 1.600 Change$Header$Change_Out 0.420 "
	                        		+ "Change$Legend 1.300 Change$Legend$Change_In 1.300 Change$Legend$Change_Out 0.320 "
	                        		+ "Change$Header_ILU 1.320 Change$Header_ILU$Change_In 1.320 Change$Header_ILU$Change_Out 0.420";
	                        if(whichGraphicOnScreen.contains(",")) {
	                            switch(whichGraphicOnScreen.split(",")[0]) {
	                            case "F1": case "Control_Shift_A":
...
//							}
						...
						case "Control_p": // PointsTable
							...
							break;
						case "z": case "x": case "c": case "v": case "Control_z": case "Control_x": case "Control_Shift_Z": case "Control_Shift_Y": case "Control_Shift_F8":
						case "Alt_Shift_U": //LeaderBoard Most - Runs,Wickets,Fours,Sixes 
		...
		if(config.getPreview().equalsIgnoreCase("WITH_PREVIEW")) {
			...
			case Constants.T20_MUMBAI:
				if(whichside == 1) {
					...
					case "d": case "e":case "Alt_F1": case "Alt_F2": case "Control_Shift_Q": case "Alt_Shift_B": 
					...
					case "d": case "e":case "Alt_F1": case "Alt_F2": case "Alt_Shift_B": 
			...
			case Constants.NPL:  case Constants.MPL: case Constants.APL:
				if(whichside == 1) {
					...
					case "Control_Shift_F10":
						...
						break;
					case "Alt_Shift_F3":
						previewCommands = "Anim_Infobar$Push 0.500 LT_Phase_Comp$In_Out 1.400 LT_Phase_Comp$In_Out$In 1.400 LT_Phase_Comp$In_Out$In$BASE 1.200 LT_Phase_Comp$In_Out$In$LOGO 1.100 "
								+ "LT_Phase_Comp$In_Out$In$HEADER 1.320 LT_Phase_Comp$In_Out$In$BOTTOM_DATA 1.320 LT_Phase_Comp$In_Out$In$SUB_DATA 1.400";
						break;
					case "Control_Shift_B":
			...
			case Constants.ICC_U19_2023:
				if(whichside == 1) {
					...
					case "Shift_F3": case "u": case "d": case "e": case "Shift_F5": case "Shift_F9": case "Alt_F12":
					case "Control_g": case "Control_h": case "Control_p": case "Control_F6": case "Shift_F6": case "Control_s":
					case "Alt_d": case "Alt_l": case "Control_f": case "l": case "n": case "a": case "Alt_F1": case "Alt_F2":case "Shift_E":
					case "Alt_F6": case "Shift_A":  case "Shift_R": case "Shift_U": case "Alt_w": case "Control_j": case "Alt_i": case "b":
			...
			case Constants.ISPL:
				if(whichside == 1) {
					...
					case "Control_p": case "Control_F6": case "Shift_F6": case "Control_s": case "Alt_d": case "Alt_l": case "Control_f": case "l": case "a": case "Alt_F1": case "Alt_F2":
			...
			case Constants.LEGENDS: case Constants.ASSAM:
				if(whichside == 1) {
					...
					case "Control_Shift_O":
						...
						break;
					case "Control_Shift_B":
						previewCommands = "Anim_Infobar$Push 0.500 LT_NextToBat$InOut 1.660 LT_NextToBat$InOut$In 1.660 "
								+ "LT_NextToBat$InOut$In$In 1.380";
						break;
					case "Shift_I":
					...
					case "Control_F3": case "Alt_k": case "Shift_F3": case "u": case "d": case "e": case "Shift_F5": case "Shift_F9": case "Alt_F12":
					case "Control_h":  case "Control_F6": case "Shift_F6": case "Control_s": case "Control_f":  case "Shift_E": case "Alt_F8": 
					case "F8": case "F10": case "a":	case "Alt_Shift_F5":case "Alt_Shift_F7":case "Alt_Shift_F6": case "Alt_d": case "Alt_l": case "Alt_Shift_F3":
					case "Control_Shift_Q":	
			...
			case Constants.T20_MUMBAI:
				if(whatToProcess.contains(",")) {
					...
					case "Shift_F1": case "Shift_F2": case "Alt_F1": case "Alt_F2":
						...
						break;
					case "Alt_F7":
						CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER PREVIEW SCENE*/Default/gfx_Overlays C:/Temp/Preview.tga anim_MiniStandings$In_Out$Essentials$In 1.780 "
								+ "anim_MiniStandings$In_Out$Header$In 0.900 anim_MiniStandings$In_Out$Data$In 1.220 \0", print_writer);
						break;
					}
				}
				break;
			...
			case Constants.NPL: case Constants.APL:
				if(whichside == 1) {
					...
					case "Control_Shift_Y": case "Control_Shift_E": case "Control_Shift_F": case "Alt_Shift_W": case "Control_Shift_F8": case "Shift_L": case "Alt_F5":
						...
						break;
					case "Control_d": case "Control_e": case "Shift_P": case "Shift_Q": case "Control_p":
					case "Alt_z": case "Shift_F8": case "Control_F10":	
						previewCommand = "Anim_Infobar$Push 0.500 Anim_FullFrames$In_Out$Essentials$In 2.800 Anim_FullFrames$In_Out$Header$In 2.000"
						...
						break;
					case "Shift_F11": case "Control_F7": case "Control_F11": 
						previewCommand = "Anim_Infobar$Push 0.500 Anim_FullFrames$In_Out$Essentials$In 2.800 Anim_FullFrames$In_Out$Header$In 2.000"
								+ " Anim_FullFrames$In_Out$SubHeader$In 2.000 Anim_FullFrames$In_Out$Footer 3.000 Anim_FullFrames$In_Out$Footer$In_Out 3.000 "
								+ "Anim_FullFrames$In_Out$Footer$In_Out$Essentials 3.000 Anim_FullFrames$In_Out$Footer$In_Out$Essentials$In 2.860 "
								+ "Anim_FullFrames$In_Out$Footer$In_Out$Data 3.000 Anim_FullFrames$In_Out$Footer$In_Out$Data$In 2.860";
					...
					case "Control_Alt_F1": case "Control_Alt_F2": case "Alt_Shift_J": case "Shift_T":
						...
						break;
					case "Shift_K": case "Control_Shift_A":
						previewCommand = "Anim_Infobar$Push 0.500 Anim_FullFrames$In_Out$Essentials$In 2.800 Anim_FullFrames$In_Out$Header$In 2.000 Anim_FullFrames$In_Out$Logo$In 2.500"
								+ " Anim_FullFrames$In_Out$SubHeader$In 2.000 Anim_FullFrames$In_Out$Footer 3.000 Anim_FullFrames$In_Out$Footer$In_Out 3.000 "
								+ "Anim_FullFrames$In_Out$Footer$In_Out$Essentials 3.000 Anim_FullFrames$In_Out$Footer$In_Out$Essentials$In 2.860 Anim_FullFrames$In_Out$Footer$In_Out$Data 3.000"
								+ " Anim_FullFrames$In_Out$Footer$In_Out$Data$In 2.860";
					...
					case "Control_Alt_F2":
						...
						break;
					case "Alt_Shift_J":
						previewCommand = previewCommand + " Anim_FullFrames$In_Out$Main 3.000 Anim_FullFrames$In_Out$Main$BattingCard_Manhattan 3.000 "
								+ "Anim_FullFrames$In_Out$Main$BattingCard_Manhattan$In 2.880 Anim_FullFrames$In_Out$ExtraData$In 3.000 "
								+ "Anim_FullFrames$In_Out$Sponsor 3.000 Anim_FullFrames$In_Out$Sponsor$In 2.500";
						break;	
					case "F1": case "Control_Shift_A": case "Control_Shift_F1":
						previewCommand = previewCommand + " Anim_FullFrames$In_Out$Main 3.000 Anim_FullFrames$In_Out$Main$BattingCard 3.000 "
								+ "Anim_FullFrames$In_Out$Main$BattingCard$In 2.880 Anim_FullFrames$In_Out$ExtraData$In 3.000 "
								+ "Anim_FullFrames$In_Out$Sponsor 3.000 Anim_FullFrames$In_Out$Sponsor$In 2.500";
						break;
					case "F2": case "Control_Shift_F2":
					...
					case "Alt_Shift_J": 
						previewCommand = previewCommand + " Change$BattingCard_Manhattan 1.980 Change$BattingCard_Manhattan$Change_Out 0.740 Change$Logo$Change_Out 1.000 Change$ExtraData 1.000 Change$ExtraData$Change_Out 0.720 "
								+ "Change$Sposor 0.900 Change$Sposor$Change_Out 0.500";
						break;
					case "Control_Alt_F1":
					...
					case "Shift_T":
						previewCommand = previewCommand + " Change$LineUp_Image 1.440 Change$LineUp_Image$Change_Out 0.620 Change$Logo$Change_Out 1.000 "
								+ "Change$ExtraData 1.000 Change$ExtraData$Change_Out 0.720 Change$Sposor 0.900 Change$Sposor$Change_Out 0.500";
						break;
					case "Control_F7":
						previewCommand = previewCommand + " Change$Teams 1.440 Change$Teams$Change_Out 0.620 Change$ExtraData 1.000 Change$ExtraData$Change_Out 0.720 Change$Sposor 0.900 Change$Sposor$Change_Out 0.500";
						break;	
					case "Control_d": case "Control_e": case "Shift_P": case "Shift_Q":
						if(!prevHighlightDirector.isEmpty()) {
					...
					case "Alt_z":
						...
						break;
					case "Shift_F8":
						previewCommand = previewCommand + " Change$TeamSingle 1.440 Change$TeamSingle$Change_Out 0.620 Change$ExtraData 1.000 Change$ExtraData$Change_Out 0.720 Change$Sposor 0.900 Change$Sposor$Change_Out 0.500";
						break;
					case "z": case "x": case "c": case "v": case "Control_z": case "Control_x": case "Control_Shift_Z": case "Control_Shift_Y": case "Control_Shift_F8":
					...
					case "Control_Shift_F8": case "Control_Shift_I": case "Control_Alt_F1": case "Control_Alt_F2": case "Alt_Shift_J": 
							...
							case "Shift_T":
								previewCommand = previewCommand + " Change$LineUp_Image 1.440 Change$LineUp_Image$Change_In 1.440 Change$Logo$Change_In 1.340 "
										+ "Change$ExtraData$Change_In 1.000 BG_Scale 0.800 Change$Sposor$Change_In 0.900";
								break;
							case "Control_F7":
								previewCommand = previewCommand + " Change$Teams 1.440 Change$Teams$Change_In 1.440 Change$ExtraData$Change_In 1.000 BG_Scale 0.800 Change$Sposor$Change_In 0.900";
								break;	
							case "Control_d": case "Control_e": case "Shift_P": case "Shift_Q":
								if(Integer.valueOf(whatToProcess.split(",")[4])>0) {
									if(Integer.valueOf(whatToProcess.split(",")[4]) == 5) {
							...
							case "Alt_z":
								...
								break;
							case "Shift_F8":
								previewCommand = previewCommand + " Change$TeamSingle 1.440 Change$TeamSingle$Change_In 1.440 Change$ExtraData$Change_In 1.000 BG_Scale 0.800 Change$Sposor$Change_In 0.900";
								break;
							case "Alt_Shift_W":	case "Shift_L":
