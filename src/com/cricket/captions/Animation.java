	...
	public String getTypeOfGraphicsOnScreen(Configuration config,String whatToProcess)
	{
		...
		case Constants.LEGENDS:
			...
			case "Control_y": case "Control_4":
				return Constants.BUGS;
			case "Shift_F1": case "Shift_F2": case "Alt_F7": case "Alt_F1": case "Alt_F2":case "Alt_Shift_F8":
				return Constants.MINIS;	
		...
		case Constants.NPL: case Constants.MPL: case Constants.APL:
			...
			case "Shift_M": case "Control_Shift_P": case "Alt_Shift_R":
				return Constants.FULL_FRAMER;
			case "Shift_O": case "Control_k": case "k": case "g": case "y": case "Control_Shift_R": case "Control_Shift_U": case "Control_Shift_V":
			case "h": case "Shift_F4": case "Shift_F":case "Alt_b": case "Alt_p": case "Control_Shift_F3":  case "Shift_C": case "Control_Shift_J": case "6":
			...
			case "Alt_a": case "Alt_s":case "Shift_E": case "Alt_q": case "Alt_F6": case "Shift_A": case "Shift_R": case "Shift_U":
			case "Alt_w": case "Control_j": case "Alt_i": case "Alt_j": case "b": case "Control_i": case "Alt_Shift_L": case "Shift_B": 
			case "Control_Shift_M": case "Control_Shift_L": case "Alt_Shift_O":
			case "Alt_Shift_D":case "Alt_Shift_E":case "Alt_Shift_F":case "Alt_Shift_G":case "Alt_Shift_H":
...
//				}
	...
	public String AnimateIn(String whatToProcess, List<PrintWriter> print_writers, Configuration config) throws InterruptedException, IOException 
	{
		...
		case Constants.LEGENDS:
			...
			case "Control_Shift_F8":case "Control_Shift_K":
				processAnimation(Constants.BACK, print_writers, "Loop", "START");
				AnimateIn("ArrowDown,", print_writers, config); // Push infobar
				TimeUnit.MILLISECONDS.sleep(500);
				switch (config.getBroadcaster().toUpperCase()) {
			...
			case "Shift_F3": case "u": case "d": case "e": case "Shift_F5": case "Shift_F9": case "Alt_F12":
			case "Control_h":  case "Control_F6": case "Shift_F6": case "Control_s": case "Control_f":  case "Shift_E": 
			case "Alt_F8": case "F8": case "F10": case "a":case "Alt_Shift_F5":case "Alt_Shift_F7":case "Alt_Shift_F6":
				if(!infobar.getInfobar_status().equalsIgnoreCase(Constants.FORCED+Constants.SHRUNK_INFOBAR)) {
					AnimateIn("ArrowLeft" + ",", print_writers, config); // Shrink infobar
					TimeUnit.MILLISECONDS.sleep(1000);
					infobar.setInfobar_status(Constants.SHRUNK_INFOBAR);
...
//				processAnimation(Constants.BACK, print_writers, "Anim_FullFrames$In_Out$Logo", "START");
			...
			case "F1": case "Control_Shift_A": case "Control_Shift_F1": case "F2": case "Control_Shift_F2": case "Control_F11": case "F4": case "Shift_K": case "Control_Shift_F4": case "Shift_F11":
			...
			case "Shift_F10": case "Control_Shift_D": case "Alt_F11": case "Control_Shift_E": case "Control_Shift_F": case "Control_Shift_I": case "Alt_Shift_J": case "Control_Alt_F1": case "Control_Alt_F2":
				AnimateIn("ArrowDown,", print_writers, config); // Push infobar
				TimeUnit.MILLISECONDS.sleep(500);
				processAnimation(Constants.BACK, print_writers, "Loop", "START");
				...
				case Constants.NPL: case Constants.MPL: case Constants.APL:
					...
					if(!whatToProcess.split(",")[0].equalsIgnoreCase("Control_F10")
					...
					if(!whatToProcess.split(",")[0].equalsIgnoreCase("Control_d") && !whatToProcess.split(",")[0].equalsIgnoreCase("Control_e")
							...
							&& !whatToProcess.split(",")[0].equalsIgnoreCase("Shift_F10")
		...
		case Constants.BENGAL_T20:
			...
			case "Shift_K": case "Alt_F9": case "Alt_F10": case "p": case "z": case "x": case "c": case "v": case "Control_z": case "Control_x": 
			case "Control_Shift_Z": case "Control_Shift_Y":
			case "Control_Shift_F8": case "Control_p": case "Alt_F11": case "Shift_Z": case "Shift_X":
			
			case "Control_Shift_F1": case "Control_Shift_F2": case "Control_Shift_F4":
			...
			case "Control_F5": case "Control_F9":  case "Control_F3": case "Alt_k":
...
//				TimeUnit.MILLISECONDS.sleep(1000);
			...
			case "z": case "x": case "c": case "v": case "Control_z": case "Control_x": case "Control_Shift_Z": case "Control_Shift_Y":
			case "Control_Shift_F8": case "Alt_F11": case "Shift_Z": case "Shift_X":
...
//						}
		...
		case Constants.LEGENDS:
			...
			case "Control_Shift_D":case "Alt_Shift_F4":case "Control_d": case "Control_e":case "Shift_P": case "Shift_Q":
			case "z": case "x": case "c": case "v":case "Control_z": case "Control_x":case "Control_Shift_F8": case "Control_Shift_K":
...
//					if(infobar.isTarget_on_screen() == true) {
//						processAnimation(Constants.FRONT, print_writers, "Anim_Infobar$Right_Bowl_Full_Over$Change", "SHOW 0.0");
//					}
				}
				break;
			case "Alt_Shift_W": case "Shift_L":
...
//				 break;
//				
//			 case "F1": case "Control_Shift_A": case "F2": case "F4": case "Shift_T": case "p": case "Control_p": case "Shift_F8": case "Control_F11":
//			 case "Shift_K":	 
//					processAnimation(Constants.BACK, print_writers, "Change$Header", "SHOW 0.0");
////					processAnimation(Constants.BACK, print_writers, "Change$Footer", "SHOW 0.0");
//					switch(whichGraphicOnScreen.split(",")[0]) {
...
//			break;	
	...
	public String T20_MumbaiAnimateIn(String whatToProcess, List<PrintWriter> print_writers,Configuration config) throws InterruptedException, IOException {
		...
		case "ArrowUp":
			if(this.infobar.isInfobar_on_screen() == true && this.infobar.isInfobar_pushed()) {
				processAnimation(Constants.FRONT, print_writers, "Push", "CONTINUE");
				this.infobar.setInfobar_pushed(false);
			}
			break;
		case "ArrowDown":
		...
		case "Shift_T":
			if(whichGraphicOnScreen.contains("Shift_T")){
				...
				processAnimation(Constants.BACK, print_writers, "FullFramers$Main$PlayingXI$In", "CONTINUE");
				...
				processAnimation(Constants.BACK, print_writers, "FullFramers$Header$In", "START");
				processAnimation(Constants.BACK, print_writers, "FullFramers$Main$PlayingXI$In", "START");
				processAnimation(Constants.BACK, print_writers, "BackVeil$Director", "START");
		...
		case "Control_F7": case "Shift_F10": case "p": case "Alt_Shift_J": case "Control_F1":
			...
			case "Control_F7":
				TimeUnit.MILLISECONDS.sleep(500);
				processAnimation(Constants.BACK, print_writers, "FullFramers$Main$TeamSquad", "START");
				break;
			case "Shift_F10":
				processAnimation(Constants.BACK, print_writers, "FullFramers$Main$Worm", "START");
				break;
			case "p":
	...
	public String T20_MumbaiAnimateOut(String whatToProcess, List<PrintWriter> print_writers,Configuration config) throws InterruptedException, IOException {
		...
		case "Shift_F10": case "Shift_F11": case "p": case "Alt_Shift_J": case "Control_F1":
			...
			case "Shift_T":
				...
				break;
			case "Control_F7": 
				processAnimation(Constants.BACK, print_writers, "FullFramers$Main$TeamSquad", "CONTINUE");
				break;
			case "Shift_F10":
				processAnimation(Constants.BACK, print_writers, "FullFramers$Main$Worm", "CONTINUE");
				break;
			case "p":
	...
	public String T20_MumbaiChangeOn(String whatToProcess, List<PrintWriter> print_writers,Configuration config) throws InterruptedException, IOException {
		...
		case "Alt_0": case "Alt_3": case "Alt_4": case "Alt_5": case "Alt_8": case "Alt_9":
			if(!caption.this_infobarGfx.matchType.equalsIgnoreCase(CricketUtil.SUPER_OVER) || caption.this_infobarGfx.matchType.trim().isEmpty()) {
				if(ExtraInfoOnScreen) {
					switch(caption.this_infobarGfx.infobar.getRight_section().toUpperCase()) {
					case "BOWLER": case "PARTNERSHIP": case CricketUtil.BOUNDARY: case "BALLS_SINCE_LAST_BOUNDARY": case CricketUtil.EXTRAS: case "LAST_X_BALLS":
					case "REVIEWS_REMAINING": case "BAT_PROFILE_CAREER": case "BALL_PROFILE_CAREER": case "TARGET": case "SMALL_EQUATION": case "LAST_WICKET":
						processAnimation(Constants.FRONT, print_writers, "Shift_Wide", "CONTINUE REVERSE");
						ExtraInfoOnScreen = false;
						break;
					}
				}else {
					switch(caption.this_infobarGfx.infobar.getRight_section().toUpperCase()) {
					case "TOSS": case CricketUtil.PROJECTED: case "FOW": case "EQUATION": case CricketUtil.RESULT: case "RESULTS": case "TIMELINE": case "COMMENTATORS":
					case "FREE_TEXT": case "COMPARE": case "PHASE_WISE_SCORE": case "ST_BAT": case "ST_BALL":
						processAnimation(Constants.FRONT, print_writers, "Shift_Wide", "CONTINUE");
						ExtraInfoOnScreen = true;
						break;
					}
				}
			}
			//TimeUnit.MILLISECONDS.sleep(200);
			processAnimation(Constants.FRONT, print_writers, "Changeon_Right", "START");
			caption.this_infobarGfx.infobar.setLast_right_section(caption.this_infobarGfx.infobar.getRight_section());
			if(caption.this_infobarGfx.infobar.getRight_section().equalsIgnoreCase("BOWLER")) {
				caption.this_infobarGfx.infobar.setLast_right_bottom(caption.this_infobarGfx.infobar.getRight_bottom());
			}
			break;
		...
		case "Shift_F3": case "Control_a": case "Control_F3": case "Shift_B": case "Control_F6": case "F6": case "Alt_Shift_F3":case "Shift_F6":case "Alt_Shift_O":
		case "Control_F9":case "Control_F5": case "d": case "e":case "Alt_F1": case "Alt_F2":
		...
		case "Shift_F10": case "Shift_F11": case "p": case "Alt_Shift_J": case "Control_F1":
			...
			if(whichGraphicOnScreen.contains(",")) {
				...
				case "Control_F7": 
					...
					break;
				case "Shift_F10":
					processAnimation(Constants.BACK, print_writers, "Change$Worm", "START");
					break;
				case "p":
				...
				case "Alt_Shift_J":
					...
					break;
				case "Control_F1":
					processAnimation(Constants.BACK, print_writers, "Change$Imagebatting", "START");
					break;
				}
			}
			TimeUnit.MILLISECONDS.sleep(500);
	...
	public String T20_MumbaiCutBack(String whatToProcess, List<PrintWriter> print_writers,Configuration config) throws InterruptedException, IOException {
		...
		case "Alt_0": case "Alt_3": case "Alt_4": case "Alt_5": case "Alt_8": case "Alt_9":
			TimeUnit.MILLISECONDS.sleep(500);
			processAnimation(Constants.FRONT, print_writers, "Changeon_Right", "SHOW 0.0");
			break;
		...
		case "Control_a": case "u": case "q": case "Control_q": case "Shift_F3": case "Control_F3": case "Shift_B": case "Control_F6": 
		case "F6": case "Alt_Shift_F3":case "Shift_F6":case "Alt_Shift_O":case "Control_F9":case "Control_F5": case "d": case "e":
		case "Alt_F1": case "Alt_F2":
			if(whatToProcess.contains("Player_ChangeON")) {
		...
		case "Shift_T":case "Control_F7": case "Shift_F11": case "Shift_F10": case "p": case "Control_F1":
			...
			case "Alt_Shift_J":
				...
				break;
			case "Control_F1":
				processAnimation(Constants.BACK, print_writers, "Change$Imagebatting", "SHOW 0.0");
				break;
			}
			...
			case "Control_F7": 
				...
				break;
			case "Shift_F10":
				processAnimation(Constants.BACK, print_writers, "FullFramers$Main$Worm", "SHOW 2.120");
				processAnimation(Constants.BACK, print_writers, "Change$Worm", "SHOW 0.0");
				break;
			case "p":
			...
			case "Alt_Shift_J":
				...
				break;
			case "Control_F1":
				processAnimation(Constants.BACK, print_writers, "FullFramers$Main$ImageBatting", "SHOW 1.480");
				processAnimation(Constants.BACK, print_writers, "Change$Imagebatting", "SHOW 0.0");
				break;
			}
			this.whichGraphicOnScreen = whatToProcess;
	...
	public void processFullFramesPreview(String whatToProcess, List<PrintWriter> print_writer, int whichside, 
		...
		if(config.getPreview().equalsIgnoreCase("WITH_PREVIEW")) {
			...
			case Constants.T20_MUMBAI:
				if(whichside == 1) {
					...
					case "Shift_T": case "Shift_F10": case "Shift_F11": case "p": case "Alt_Shift_J": case "Control_F1":
						...
						case "Control_F7": 
							...
							break;
						case "Shift_T":
							previewCommand = previewCommand + "FullFramers$Main$PlayingXI 1.820 FullFramers$Main$PlayingXI$In 0.560";
							break;
						case "Shift_F10":
							previewCommand = previewCommand + "FullFramers$Main$Worm 2.120 FullFramers$Main$Worm$In 1.640 FullFramers$Main$Worm$In$Runs 1.640";
							break;
						case "p":
							previewCommand = previewCommand + "FullFramers$Main$PointsTable 1.480 FullFramers$Main$PointsTable$In 0.800";
							break;
						case "Alt_Shift_J":
							previewCommand = previewCommand + "FullFramers$Main$BatManhatton 1.480 FullFramers$Main$BatManhatton$In 1.500";
							break;
						case "Control_F1":
							previewCommand = previewCommand + "FullFramers$Main$ImageBatting 1.480 FullFramers$Main$ImageBatting$In 1.000";
							break;
						}
						break;
					}
					...
					case "Shift_F10": case "Shift_F11": case "p": case "Alt_Shift_J": case "Control_F1":
						...
						case "Control_F7":
							...
							break;
						case "Shift_F10":
							previewCommand = previewCommand + " Change$Worm 1.640 Change$Worm$ChangeIn 1.640 Change$Worm$ChangeIn$Runs 1.640 Change$Worm$ChangeOut 0.860";
							break;
						case "p":
							previewCommand = previewCommand + " Change$PointsTable 0.800 Change$PointsTable$ChangeOut 0.560 Change$PointsTable$ChangeIn 0.800";
							break;
						case "Alt_Shift_J":
							previewCommand = previewCommand + " Change$BatManhatton 1.440 Change$BatManhatton$ChangeOut 0.680 Change$BatManhatton$ChangeIn 1.440";
							break;
						case "Control_F1":
							previewCommand = previewCommand + " Change$Imagebatting 0.800 Change$Imagebatting$ChangeOut 0.320 Change$Imagebatting$ChangeIn 0.800";
							break;
						}
				...
				CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER PREVIEW SCENE*/T20/Scenes/FF_FullFrames " 
						+ "C:/Temp/Preview.tga " + previewCommand + "\0", print_writer);
				break;
			case Constants.LEGENDS:
				if(whichside == 1) {
					...
					case "Control_d": case "Control_e": case "Shift_P": case "Shift_Q":
						...
						break;
					case "m": case "Control_m": case "Shift_K": case "F4": case "Shift_T": case "F1": case "F2": case "Control_F7": case "Control_F11":
					case "Shift_F10": case "Control_p": case "Shift_F11": case "Control_F10": case "Control_Shift_F5": case "Control_Shift_D": case "Alt_Shift_F4":
					case "z": case "x": case "c": case "v":case "Control_z": case "Control_x":case "Control_Shift_F8":case "Control_Shift_K":
					...
					case "Control_Shift_F8":case "Control_Shift_K":
						...
						case "z": case "x": case "c": case "v":case "Control_z": case "Control_x":case "Control_Shift_F8":
							if(!whichGraphicOnScreen.split(",")[0].equalsIgnoreCase("z") && !whichGraphicOnScreen.split(",")[0].equalsIgnoreCase("x")
								...
								!whichGraphicOnScreen.split(",")[0].equalsIgnoreCase("Control_Shift_F8")) {								
								previewCommand = "anim_Change$LeaderBoard 1.400 anim_Change$LeaderBoard$Change_Out 0.600 anim_Change$LeaderBoard$Change_In 1.400 ";
							}
							break;
						case "Alt_Shift_F4":
			...
			case Constants.NPL: case Constants.APL:
				if(whichside == 1) {
					...
					case "Control_Shift_Y": case "Control_Shift_E": case "Control_Shift_F": case "Alt_Shift_W": case "Control_Shift_F8": case "Shift_L":
						previewCommand = "Anim_Infobar$Push 0.500 Anim_FullFrames$In_Out$Essentials$In 2.800 Anim_FullFrames$In_Out$Header$In 2.000"
		...
		if(config.getPreview().equalsIgnoreCase("WITH_PREVIEW")) {
			...
			case Constants.T20_MUMBAI:
				if(whichside == 1) {
					...
					case "Shift_B": case "Control_F6": case "F6": case "Alt_Shift_F3":case "Shift_F6":case "Alt_Shift_O":
					case "Control_F5":case "Control_F9": case "d": case "e":case "Alt_F1": case "Alt_F2":
						previewCommands = "SrinkInfobar 1.180 PositionForInfobar$ForShrinK 0.0 "
								+ "BaseWidth 0.600 L3_In-Out 2.480 HeaderChange$Side1$In 1.020 Body$Side1$In 0.438";
						break;
					case "F8": case "Alt_F8": case "F10": case "j":
					...
					case "Shift_B": case "Control_F6": case "F6": case "Alt_Shift_F3":case "Shift_F6":case "Alt_Shift_O":
					case "Control_F5":case "Control_F9": case "d": case "e":case "Alt_F1": case "Alt_F2":
						previewCommands = "BaseWidth 0.600 HeaderChange$Side2 0.940 HeaderChange$Side2$ChangeOut 0.340 HeaderChange$Side2$ChangeIn 0.940 "
								+ "Body$Side2 0.400 Body$Side2$ChangeIn 0.400 Body$Side2$ChangeOut 0.440";
						break;
					case "F8": case "Alt_F8":case "F10": case "j": 
...
//					    	+ "C:/Temp/Preview.tga " + previewCommands + " \0", print_writer);
			...
			case Constants.LEGENDS:
				if(whichside == 1) {
					...
					case "Control_F3": case "Alt_k": case "Shift_F3": case "u": case "d": case "e": case "Shift_F5": case "Shift_F9": case "Alt_F12":
					case "Control_h":  case "Control_F6": case "Shift_F6": case "Control_s": case "Control_f":  case "Shift_E": case "Alt_F8": 
					case "F8": case "F10": case "a":	case "Alt_Shift_F5":case "Alt_Shift_F7":case "Alt_Shift_F6":
